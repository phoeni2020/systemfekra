    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item"><a class="navbar-brand" href="<?php echo e(url('/admin/dashboard')); ?>"><img class="brand-logo" src="/assets/images/logo-sm.png" alt="logo">
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="<?php echo e(url('logout')); ?>"><i class="ft-power"></i> خروج</a>
                        </div>
                    </li>
                </ul>
            </div>
...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main font-theme" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="nav-item">
                <a href="<?php echo e(url('admin/dashboard')); ?>"><i class="icon-home"></i><span class="menu-title">الرئيسية</span></a>
            </li>

            <li class="nav-item">
                <a href="<?php echo e(url('admin/statement')); ?>"><i class="icon-home"></i><span class="menu-title">كشف حساب</span></a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(url('admin/catch')); ?>"><i class="icon-home"></i><span class="menu-title">سند القبض</span></a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(url('admin/cashing')); ?>"><i class="icon-home"></i><span class="menu-title">سند الصرف</span></a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(url('admin/upload')); ?>"><i class="icon-home"></i><span class="menu-title">ادخال قيود</span></a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(url('admin/daily')); ?>"><i class="icon-home"></i><span class="menu-title">القيود اليومية</span></a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(url('admin/review')); ?>"><i class="icon-home"></i><span class="menu-title">ميزان المراجعة</span></a>
            </li>
            <li class="nav-item has-sub">
                <a href="#"><i class="icon-speedometer"></i><span class="menu-title">الحسابات الرئيسية</span></a>
                <ul class="menu-content">
                    <li><a href="<?php echo e(url('admin/main')); ?>">  قائمة الحسابات الرئيسية</a></li>
                    <li><a href="<?php echo e(url('admin/main/create')); ?>">إضافة حساب</a></li>
                </ul>
            </li>
            <li class="nav-item has-sub">
                <a href="#"><i class="icon-speedometer"></i><span class="menu-title">الحسابات</span></a>
                <ul class="menu-content">
                    <li><a href="<?php echo e(url('admin/account')); ?>">قائمة الحسابات</a></li>
                    <li><a href="<?php echo e(url('admin/account/create')); ?>">إضافة حساب</a></li>
                </ul>
            </li>
...
<?php /**PATH /home/codeitco/accountant.3codeit.com/resources/views/layout/master.blade.php ENDPATH**/ ?>