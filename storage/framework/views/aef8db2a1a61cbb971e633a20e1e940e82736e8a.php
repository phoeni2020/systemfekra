                            ...
                            <table class="table table-bordered table-striped datatable">
                                ...
                                <?php $__currentLoopData = $drivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td> <a href="<?php echo e(url('admin/userTransaction/'.$driver->account_id)); ?>"> <?php echo e($driver->account->name); ?></a></td>
                                        ...
                                        <td>
                                            ...
                                            <form class="myform"  id="<?php echo e($driver->id); ?>" onclick="return confirm('هل انت متأكد من الحذف ؟')"  method="post"  action="<?php echo e('statement/delete/'.$driver->id); ?>">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codeitco/accountant.3codeit.com/resources/views/account/daily.blade.php ENDPATH**/ ?>