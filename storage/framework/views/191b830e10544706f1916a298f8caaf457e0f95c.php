    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-12 mb-2">
                <h3 class="content-header-title font-theme ls-0">إضافة سند صرف</h3>
            </div>
        </div>
        <div class="content-body">
            <div class="card">
                ...
                <div class="card-block">
                    <div class="card-body">
                        <form method="post" action="/admin/cache" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="statement" value="<?php if($transaction): ?><?php echo e($transaction->id+1); ?> <?php else: ?> 1 <?php endif; ?>" required class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
...
<?php echo $__env->make('layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codeitco/accountant.3codeit.com/resources/views/account/cache.blade.php ENDPATH**/ ?>