                ...
                <div class="card">
                    <div class="card-block">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo e(route('products.update',$driver->id)); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-2 order-md-1 order-2">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8"><input type="text" name="name" value="<?php echo e($driver->name); ?>" class="form-control bg-gray-light"></div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="store_id">
                                                        <?php $__currentLoopData = $stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <?php if($driver->store_id==$store->id): ?>selected <?php endif; ?>><?php echo e($store->name); ?></option>
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="supplier_id">
                                                        <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($store->id); ?>"
                                                                    <?php if($driver->supplier_id==$store->id): ?>selected <?php endif; ?>><?php echo e($store->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="classificaiton_id">
                                                        <?php $__currentLoopData = $classifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($store->id); ?>"
                                                                    <?php if($driver->classificaiton_id==$store->id): ?>selected <?php endif; ?>><?php echo e($store->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4 mb-2 order-md-1 order-3">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8"><input type="number" step="0.1" value="<?php echo e($driver->min_price); ?>"  name="min_price" class="form-control bg-gray-light"></div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-form-label col-sm-4">الحد الاعلى</label>
                                                <div class="col-sm-8"><input type="number" step="0.1" value="<?php echo e($driver->max_price); ?>"  name="max_price" class="form-control bg-gray-light"></div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-form-label col-sm-4">نظام التسعير</label>
                                                <div class="col-sm-8"><input type="text" name="price_system" value="<?php echo e($driver->price_system); ?>"  class="form-control bg-gray-light"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-7"><input name="type_0" value="<?php echo e($baku->type); ?>"  type="text" class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-sm-4 rounded-pill bg-orange text-center mx-2">الوحدة</label>
                                                                        <div class="col-sm-7"><input type="text"  value="<?php echo e($baku->unit); ?>"  name="unit_0" class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-7"><input type="number" name="price_0"   value="<?php echo e($baku->price); ?>"  step="0.1" class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-sm-4 rounded-pill bg-orange text-center mx-2">نسبة الخصم المسموح به</label>
                                                                        <div class="col-sm-7"><input type="text" name="dicount_0"  value="<?php echo e($baku->dicount); ?>"  class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-7"><input type="text" name="order_0"  value="<?php echo e($baku->order); ?>"  class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-sm-4 rounded-pill bg-orange text-center mx-2">الرصيد الحالى</label>
                                                                        <div class="col-sm-7"><input type="number" name="current_price_0"   value="<?php echo e($baku->current_price); ?>"  step="0.1" class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-7"><input type="text"  value="<?php echo e($baku->bacode1); ?>"  name="bacode1_0" class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-sm-4 rounded-pill bg-orange text-center mx-2">باكود 2</label>
                                                                        <div class="col-sm-7"><input type="text"  value="<?php echo e($baku->bacode2); ?>"  name="bacode2_0"class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="tab-pane fade" id="tab_2">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-sm-4 rounded-pill bg-orange text-center mx-2">النوع</label>
                                                                        <div class="col-sm-7"><input name="type_2" value="<?php echo e($box->type_2); ?>"  type="text" class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-sm-4 rounded-pill bg-orange text-center mx-2">الوحدة</label>
                                                                        <div class="col-sm-7"><input type="text" value="<?php echo e($box->unit_2); ?>"  name="unit_2" class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-sm-4 rounded-pill bg-orange text-center mx-2">سعر الشراء</label>
                                                                        <div class="col-sm-7"><input type="number" value="<?php echo e($box->price_2); ?>"  name="price_2" step="0.1" class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-sm-4 rounded-pill bg-orange text-center mx-2">نسبة الخصم المسموح به</label>
                                                                        <div class="col-sm-7"><input type="text" value="<?php echo e($box->dicount_2); ?>"  name="dicount_2" class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-sm-4 rounded-pill bg-orange text-center mx-2">حد الطلب</label>
                                                                        <div class="col-sm-7"><input type="text" value="<?php echo e($box->order_2); ?>"  name="order_2" class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-sm-4 rounded-pill bg-orange text-center mx-2">الرصيد الحالى</label>
                                                                        <div class="col-sm-7"><input type="number"  value="<?php echo e($box->current_price_2); ?>"  name="current_price_2" step="0.1" class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-sm-4 rounded-pill bg-orange text-center mx-2">باكود 1</label>
                                                                        <div class="col-sm-7"><input type="text" value="<?php echo e($box->bacode1_2); ?>"  name="bacode1_2" class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-sm-4 rounded-pill bg-orange text-center mx-2">باكود 2</label>
                                                                        <div class="col-sm-7"><input type="text"  value="<?php echo e($box->bacode2_2); ?>"  name="bacode2_2"class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="tab-pane fade" id="tab_3">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-sm-4 rounded-pill bg-orange text-center mx-2">النوع</label>
                                                                        <div class="col-sm-7"><input name="type_3" value="<?php echo e($carton->type_3); ?>"  type="text" class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-sm-4 rounded-pill bg-orange text-center mx-2">الوحدة</label>
                                                                        <div class="col-sm-7"><input type="text" value="<?php echo e($carton->unit_3); ?>"  name="unit_3" class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-sm-4 rounded-pill bg-orange text-center mx-2">سعر الشراء</label>
                                                                        <div class="col-sm-7"><input type="number" value="<?php echo e($carton->price_3); ?>"  name="price_3" step="0.1" class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-sm-4 rounded-pill bg-orange text-center mx-2">نسبة الخصم المسموح به</label>
                                                                        <div class="col-sm-7"><input type="text" value="<?php echo e($carton->dicount_3); ?>"  name="dicount_3" class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-sm-4 rounded-pill bg-orange text-center mx-2">حد الطلب</label>
                                                                        <div class="col-sm-7"><input type="text" value="<?php echo e($carton->order_3); ?>"  name="order_3" class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-sm-4 rounded-pill bg-orange text-center mx-2">الرصيد الحالى</label>
                                                                        <div class="col-sm-7"><input type="number" value="<?php echo e($carton->current_price_3); ?>"  name="current_price_3" step="0.1" class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-sm-4 rounded-pill bg-orange text-center mx-2">باكود 1</label>
                                                                        <div class="col-sm-7"><input type="text" value="<?php echo e($carton->bacode1_3); ?>"  name="bacode1_3" class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-sm-4 rounded-pill bg-orange text-center mx-2">باكود 2</label>
                                                                        <div class="col-sm-7"><input type="text"  value="<?php echo e($carton->bacode2_3); ?>"  name="bacode2_3"class="form-control bg-gray-light"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
...
<?php echo $__env->make('layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codeitco/accountant.3codeit.com/resources/views/admin/products/edit.blade.php ENDPATH**/ ?>