                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped datatable">
                                ...
                                <tr>
                                    ...
                                    <?php if($driver->main): ?>
                                    <td><?php echo e($driver->main->name); ?></td>
                                    <?php else: ?> <td></td>
                                    <?php endif; ?>
                                    ...
                                    <td>
                                        ...
                                        <form class="myform"  id="<?php echo e($driver->id); ?>"  method="post"  action="<?php echo e((route('account.destroy',$driver->id))); ?>">
                                            <?php echo csrf_field(); ?>
                                            <a href="<?php echo e((route('account.edit',$driver->id))); ?>" class="btn btn-success a-btn-slide-text">
...
<?php echo $__env->make('layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codeitco/accountant.3codeit.com/resources/views/admin/account/index.blade.php ENDPATH**/ ?>