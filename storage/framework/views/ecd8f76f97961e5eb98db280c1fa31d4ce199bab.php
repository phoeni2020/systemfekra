                                        ...
                                        <div class="col-md-4 mb-1 order-md-1 order-2">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8"><input type="text" name="date"
                                                                       ...
                                                                       value="<?php echo e($driver->date); ?>"      id="current-date"></div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8"><select name="supplier"
                                                        ...
                                                        <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($supplier->id); ?>" <?php if($supplier->id==$driver->supplier_id): ?>selected <?php endif; ?>><?php echo e($supplier->name); ?></option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8"><select name="store"
                                                        ...
                                                        <?php $__currentLoopData = $stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($supplier->id); ?>" <?php if($supplier->id==$driver->store_id): ?>selected <?php endif; ?>><?php echo e($supplier->name); ?></option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8"><input type="text" name="order" value="<?php echo e($driver->order); ?>"
                                                                             class="form-control bg-gray-light"></div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-form-label col-sm-4">رقم القيد</label>
                                                <div class="col-sm-8"><input type="text" name="registration_number" value="<?php echo e($driver->registration_number); ?>"
                                                                             class="form-control bg-gray-light"></div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="type" class="form-control bg-gray-light custom-select">
                                                        <option value="نقدي" <?php if($driver->type=="نقدى"): ?>selected <?php endif; ?>>نقدى</option>
                                                        <option value="فيزا" <?php if($driver->type=="فيزا"): ?>selected <?php endif; ?>>فيزا</option>

                                                        <option value="اجل" <?php if($driver->type=="اجل"): ?>selected <?php endif; ?>>اجل</option>
                                                    </select>
                                                </div>
                                            </div>
                                                    ...
                                                    <table class="table table-head-fixed text-nowrap table-striped-td table-input-td text-center"
                                                        ...
                                                        <tr id="invoicerow_1">
                                                            <td><select data-type="name" required
                                                                        ...
                                                                        <option value="<?php echo e($product->id); ?>"><?php echo e($product->product->name); ?></option>

                                                                </select></td>
                                                            <td><input type="number" value="<?php echo e($product->quantity); ?>" readonly
                                                            ...
                                                            <td><select data-type="unit"
                                                                    ...
                                                                    <option value="وحدة" <?php if($product->unit=="وحدة"): ?> selected <?php endif; ?>> باكو/وحدة</option>
                                                                    <option value="علبة" <?php if($product->unit=="علبة"): ?> selected <?php endif; ?>>علبة</option>
                                                                    <option value="كارتونة" <?php if($product->unit=="كارتونة"): ?> selected <?php endif; ?>>كارتونة</option>

                                                                </select></td>
                                                            <td><input type="number" data-type="price"
                                                                       class="form-control bg-transparent border-0 inputs autocomplete_txt"
                                                                       readonly id="price_1" name="price[]" value="<?php echo e($product->product->price_system); ?>" readonly
                                                                       autocomplete="off"></td>
                                                            <td><input type="number"
                                                                       class="form-control bg-transparent border-0 totals inputs sal-lst" value="<?php echo e($product->total); ?>"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8"><input type="text" id="total" readonly name="total" value="<?php echo e($driver->total -$driver->tax + $driver->discount); ?>"
                                                                             class="form-control bg-gray-light"/></div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-form-label col-sm-4 font-weight-bold">الخصم</label>
                                                <div class="col-sm-8"><input type="text" onchange="updateTotal()" id="discount" name="discount" value="<?php echo e($driver->discount); ?>"
                                                                             class="form-control bg-gray-light"/></div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-form-label col-sm-4 font-weight-bold">الضريبة</label>
                                                <div class="col-sm-8"><input type="text" id="tax" readonly name="tax" value="<?php echo e($driver->tax); ?>"
                                                                             class="form-control bg-gray-light"/></div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-form-label col-sm-4 font-weight-bold">المبلغ بعد
                                                    الضريبة</label>
                                                <div class="col-sm-8"><input type="text"  id="final" readonly name="final" value="<?php echo e($driver->total); ?>"
                                                                             class="form-control bg-gray-light"/></div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codeitco/accountant.3codeit.com/resources/views/admin/purchase/show.blade.php ENDPATH**/ ?>