                ...
                <div class="card">
                    <div class="card-block">
                        ...
                        <div class="card-body">
                            ...
                            <form id="add-form" action="/admin/sell" method="post">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-1 text-center order-md-1 order-1">
                                            ...
                                            <h5 class="modal-title">فاتورة مبيعات</h5>
                                        </div>
...
<?php echo $__env->make('layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codeitco/accountant.3codeit.com/resources/views/admin/purchase/sell.blade.php ENDPATH**/ ?>