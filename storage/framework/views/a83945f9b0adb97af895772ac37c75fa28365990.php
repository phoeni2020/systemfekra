            ...
            <div class="content-body">
                <div class="card">
                    <div class="card-block">
                        ...
                        <div class="card-body">
                            ...
                            <form id="add-form" action="/admin/sellReturn" method="post">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-1 order-md-1 order-2">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8"><input type="text" required name="client"
                                        ...
                                        <div class="col-md-4 mb-1 text-center order-md-1 order-1">
                                            ...
                                            <h5 class="modal-title">فاتورة مردود مبيعات</h5>
                                        </div>
                ...
                <script>
                    ...
                    function selectProduct(element, row) {
                        ...
                        $.ajax({
                            url: '/admin/getSell/?id=' + $('#name_' + row).val() + '&type=' + $('#unit_' + row).val(),
                            type: 'get',
...
<?php echo $__env->make('layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codeitco/accountant.3codeit.com/resources/views/admin/purchase/sellReturn.blade.php ENDPATH**/ ?>