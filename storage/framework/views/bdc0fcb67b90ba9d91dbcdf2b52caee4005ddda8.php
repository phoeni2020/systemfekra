    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-8 col-12 mb-2">
                <center>
                <h3 class="content-header-title font-theme ls-0">فواتير الشراء
                </h3>
                </center>
            </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-head-fixed text-nowrap table-striped-td table-sm-td text-center">
                                ...
                                <tr>
                                    <td> <a href="<?php echo e((route('purchase.show',$drive->id))); ?>"><?php echo e($drive->id); ?></a></td>
...
<?php echo $__env->make('layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codeitco/accountant.3codeit.com/resources/views/admin/purchase/index.blade.php ENDPATH**/ ?>