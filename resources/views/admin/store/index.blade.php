    ...
    <div class="content-wrapper">
        <div class="content-header row">
            ...
            <div class="content-header-right col-md-4 col-12 mb-2">
                <a href="{{url('admin/store/create')}}" class="btn btn-primary"><i class="icon-plus"></i> إضافة </a>
            </div>
        </div>
...
{{--                                        <a href="#" class="btn btn-icon btn-sm btn-danger"><i class="ft-trash-2"></i></a>--}}
                                        ...
                                        <form class="myform"  id="{{$driver->id}}"  method="post"  action="{{(route('store.destroy',$driver->id))}}">
                                            @csrf
                                            <a href="{{(route('store.edit',$driver->id))}}" class="btn btn-success a-btn-slide-text">
