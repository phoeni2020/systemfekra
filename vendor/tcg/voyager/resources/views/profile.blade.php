...
@section('content')
    <div style="background-size:cover; background-image: url({{ url('/storage/'.  Voyager::setting('admin.bg_image'), voyager_asset('/images/bg.jpg')) }}); background-position: center center;position:absolute; top:0; left:0; width:100%; height:300px;"></div>
